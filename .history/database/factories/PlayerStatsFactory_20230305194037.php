...
class PlayerStatsFactory extends Factory
{
    ...
    public function definition(): array
    {
        return [
            ...
            'headed_clearances' => $this->faker->numberBetween(0, 100),
            'clearances_off_line' => $this->faker->numberBetween(0, 100),
            ...
            'successful_50_50s' => $this->faker->numberBetween(0, 100),
            'aerial_battles_won' => $this->faker->numberBetween(0, 100),
            'aerial_battles_lost' => $this->faker->numberBetween(0, 100),
