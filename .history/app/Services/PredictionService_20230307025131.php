...
class PredictionService
{
    ...
    public function predict()
    {
        ...
        // calculate the percentage of the championship prediction rate
        $totalChampionshipPredictionRate = $simulations->sum('championshipPredictionRate');
        $simulations->each(function ($team) use ($totalChampionshipPredictionRate) {
            $team->championshipPredictionRatePercentage = $team->championshipPredictionRate / $totalChampionshipPredictionRate;
        });
