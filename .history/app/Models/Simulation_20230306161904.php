...
class Simulation extends Model
{
    ...
    public function simulateAllGames()
    {
        ...
        foreach ($fixtures as $fixture) {
            ...
            $homeTeamPlayedGames = $homeTeam->teamStats->played_games;
            $awayTeamPlayedGames = $awayTeam->teamStats->played_games;
            ...
            $homeTeam->teamStats()->update([
                'played_games' => $homeTeamPlayedGames + 1,
            ...
            $awayTeam->teamStats()->update([
                'played_games' => $awayTeamPlayedGames + 1,
