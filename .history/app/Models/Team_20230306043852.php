    ...
    public function generateFixtures()
    {
        ...
        for ($i = 0; $i < count($teams); $i++) {
            for ($j = $i + 1; $j < count($teams); $j++) {
                ...
                $fixtures[] = ['home_team_id' => $home['team_id'], 'away_team_id' => $away['team_id'], 'week' => $home['week'], 'league_id' => 1];
                $fixtures[] = ['home_team_id' => $away['team_id'], 'away_team_id' => $home['team_id'], 'week' => $away['week'], 'league_id' => 1];
            }
        }
