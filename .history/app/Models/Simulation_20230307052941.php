...
class Simulation extends Model
{
    ...
    public function calculateSimulationWeightScore()
    {
        ...
        $weightScore += $this->lost * -3;
        $weightScore += $this->goals_for * 2;
        $weightScore += $this->goals_against * -2;
        $weightScore += $this->goal_difference * 2;
        $weightScore += $this->points;
    ...
    public function simulateByWeek($week)
    {
        ...
        $fixtures = Fixture::with(['homeTeam', 'awayTeam'])->where('week', $this->getCurrentWeek())->get();
     ...
     * @return void
     */
    public function SimulateFixtures2()
    {
