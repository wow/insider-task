...
class PlayerStats extends Model
{
    ...
    {
        $playerStats = PlayerStats::where('player_id', $playerId)->first();

        return $this->calculatePlayerWeightScore($playerStats);
    }
     ...
     * @return float
     */
    private function calculatePlayerWeightScore($playerStats): float
    {
