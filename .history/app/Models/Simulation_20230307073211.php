...
class Simulation extends Model
{
    ...
    public function calculateSimulationWeightScore()
    {
        ...
        $weightScore += $this->lost * -2.1;
        $weightScore += $this->goals_for * 1.6;
        $weightScore += $this->goals_against * -1.1;
        $weightScore += $this->goal_difference * 0.8;
        $weightScore += $this->points * 1.8;
