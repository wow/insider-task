...
class Simulation extends Model
{
    ...
    public function calculateSimulationWeightScore()
    {
        ...
        $weightScore += $this->won * 3.1;
        $weightScore += $this->drawn * 1.2;
        $weightScore += $this->lost * -2.3;
        $weightScore += $this->goals_for * 1.9;
        $weightScore += $this->goals_against * -1.3;
        $weightScore += $this->goal_difference * 1.4;
        $weightScore += $this->points * 1.7;
    ...
    {
        $difference = $this->goals_for - $this->goals_against;
