      ...
      <div class="overflow-x-auto sm:-mx-6 lg:-mx-8">
        <div class="inline-block min-w-full py-2 sm:px-6 lg:px-8">
            ...
            <table class="min-w-full text-center text-sm font-light">
              ...
              <tbody>
                ...
                >
                  ...
                  <td class="whitespace-nowrap px-6 py-4">{{ standingTable.lost }}</td>
                  <td class="whitespace-nowrap px-6 py-4">{{ standingTable.goals_for }}</td>
                  <td class="whitespace-nowrap px-6 py-4">{{ standingTable.goals_against }}</td>
                  <td class="whitespace-nowrap px-6 py-4">{{ standingTable.goal_difference }}</td>
                  <td class="whitespace-nowrap px-6 py-4">{{ standingTable.points }}</td>
                </tr>
              </tbody>
            </table>
          </div>
          ...
          <div class="flex justify-end mt-4">
            <NavLink href="/simulations/simulate" method="post" as="button"
